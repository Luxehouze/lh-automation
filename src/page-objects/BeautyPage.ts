...
export class BeautyPage extends BasePage {
    ...
    get priceCT() { return this.page.locator('.red-5.semibold.title-3.work-sans.svelte-1j3rafz') }
    ...
    get resultDior() { return this.page.locator(`//div[1]/h1/a`); }
    get resultHotRightNow() { return this.page.getByText('HOT RIGHT NOW').first(); }
    ...
    public async verifyResultFilterBeauty(): Promise<void> {
        ...
        await this.page.waitForTimeout(4000);
        expect (this.resultDior).toBeVisible();
    }
}